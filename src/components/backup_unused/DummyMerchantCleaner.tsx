...
export function DummyMerchantCleaner() {
  ...
  if (deleted && dummyMerchants.length === 0) {
    return (
      <Card className="w-full max-w-4xl mx-auto">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-green-600">
            <CheckCircle className="h-5 w-5" />
            Dummy Merchants Cleaned
          </CardTitle>
          <CardDescription>
            All dummy merchants have been successfully removed from the database.
          </CardDescription>
        </CardHeader>
      </Card>
    );
    ...
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Clean Dummy Merchants
        </CardTitle>
        <CardDescription>
          Remove all test merchant profiles from the database.
        </CardDescription>
      </CardHeader>
