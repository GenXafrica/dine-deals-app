...
>(({ className, style, ...props }, ref) => {
  const mergedStyle: React.CSSProperties = {
    zIndex: 2147483647,
    bottom: "calc(var(--dd-bottom-bar-h, 80px) + env(safe-area-inset-bottom, 12px))",
    ...style,
  }
  ...
  return (
    <ToastPrimitives.Viewport
      ...
      style={mergedStyle}
      className={cn(
        "fixed left-1/2 transform -translate-x-1/2 flex max-h-screen w-full flex-col-reverse p-4 md:max-w-[420px]",
        className
      )}
      {...props}
    />
