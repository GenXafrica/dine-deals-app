...
const PLACEHOLDER_IMAGE = 'https://d64gsuwffb70l.cloudfront.net/683946324043f54d19950def_1749044351325_dffa81dd.jpg';
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          {activeDeals.map((deal) => (
            <div key={deal.id} className="bg-gradient-to-r from-orange-50 to-red-50 p-3 rounded-lg border">
              <div className="mb-2">
                <h5
...
>
  {deal.description}
              ...
              <img 
                src={(deal as any).image || PLACEHOLDER_IMAGE} 
                alt={deal.title}
